    ...
    <section id="home" className="w-full flex flex-col-reverse lg:flex-row justify-center min-h-screen max-container">
      <div className="relative flex flex-col justify-center items-start w-full lg:w-1/2 max-xl:padding-x pt-6 max-sm:pb-16">
        <h1 className="mt-6 font-publicsans xl:text-6xl lg:text-4xl md:text-4xl max-sm:text-[38px] max-sm:leading-none font-bold">
          Restaurant<br />that <span className="font-kalam text-red xl:text-7xl lg:text-4xl md:text-4xl max-sm:text-[42px]">inspires</span><br />you to<span className="text-red">...</span>
        </h1>
      </div>
