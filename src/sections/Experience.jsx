  ...
  return (
    <section id="experience" className="w-full flex flex-col-reverse lg:flex-row justify-center min-h-screen max-container">
      <div className="relative flex flex-col justify-center items-start w-full lg:w-1/2 max-xl:padding-x pt-6 max-sm:pb-16">
        ...
        <span className="font-kalam text-red">Experience</span><br/>Phygital<br/>Flavors<span className="text-red">.</span>
        </h1>
        <h2 className="mt-6 xl:text-4xl lg:text-4xl md:text-4xl max-sm:text-3xl text-gray font-publicsans font-bold text-center max-sm:leading-tight">
          From YouTube<br/>To Your Plate
    </h2>
      </div>
